...
left_data = pd.read_csv (r'C:/Users/angel/Desktop/FALL 2020/EE/Project/Left Limb_2020_09_05.csv')
print(left_data.shape)
left_data.info()

# fill missing values with mean column values
left_data = left_data.dropna(axis=1, how='any')
...
with open("Left_Limb_ALL_output.txt", "w") as text_file:
...
plt.savefig('Left_training_plot.png')
...
plt.savefig('Left_testing_plot.png')
