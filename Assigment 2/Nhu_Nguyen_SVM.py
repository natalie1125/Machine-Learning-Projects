...
#************************************************************************************
# Nhu Nguyen
# EE5321 – HW#2 - SVM model
# Filename: Nhu_Nguyen_SVM.py
# Due: 9/23/20
##************************************************************************************
...
svm = SVC(kernel='linear', C=10, random_state=1, max_iter=-1)
...
train_acc = ('\nTraining Accuracy: %.2f' % svm.score(X_train_std, y_train))
test_acc = ('\nTest Accuracy: %.2f' % svm.score(X_test_std, y_test))
...
SVM_file = open("C:/Users/angel/Desktop/FALL 2020/EE/Assignment 2/SVM_output.txt","w")
   
SVM_file.write(train_acc)
SVM_file.write(test_acc)
SVM_file.write(miss_sample)
...
plt.figure(1)
plot_decision_regions(X=X_combined_std, y=y_combined, classifier=svm, test_idx=range(1, 144))
